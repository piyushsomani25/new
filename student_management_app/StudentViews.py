...
from student_management_app.models import CustomUser, Staffs,Department, Subjects, Students, Attendance, AttendanceReport, FeedBackStudent, StudentResult
...
def student_home(request):
    ...
    course_obj = Department.objects.get(id=student_obj.dept_id.id)
    total_subjects = Subjects.objects.filter(dept_id=course_obj).count()
...
def student_view_attendance(request):
    ...
    course = student.dept_id # Getting Course Enrolled of LoggedIn Student
    # course = Courses.objects.get(id=student.course_id.id) # Getting Course Enrolled of LoggedIn Student
    subjects = Subjects.objects.filter(dept_id=course) # Getting the Subjects of Course Enrolled
    context = {
        "subjects": subjects
    }
