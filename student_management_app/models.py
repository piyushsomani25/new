...
class Staffs(models.Model):
    ...
    phn_no=models.IntegerField(max_length=10)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    objects = models.Manager()
...
class StudentResult(models.Model):
    ...
    cie_1= models.FloatField(default=0)
    cie_2= models.FloatField(default=0)
    cie_3= models.FloatField(default=0)
    quiz_1=models.FloatField(default=0)
    quiz_2=models.FloatField(default=0)
    quiz_3=models.FloatField(default=0)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    objects = models.Manager()
